...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <li ><a href="http://localhost/sahil/slogin.php">Login/Signup  <span class="glyphicon glyphicon-home" aria-hidden="true"></a></li>
      ...
      <li ><a href="http://localhost/sahil/aboutus.php">About Us  <span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></a></li>    
       <li ><a href="#">Contact Us<button class="icon-button"> <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></button></a></li> 	
	</ul>
  </div>
</nav>
